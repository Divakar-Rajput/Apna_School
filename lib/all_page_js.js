var array_search_suggestions = [
    ["html", "https://github.com/Divakar-Rajput/Apna_School/blob/b708164ca7aba6c6c6ec33409b646f679f65d7a0/tutorials/html/default.htmll", "HTML Tutorial"],
    ...
    function openLangTab(evtEd, codeName) {
      ...
      function find_search_results(inp) {
        ...
        if (resultIndexes.length == 0) {
          classAtt = "";
          if (html == "") classAtt = " search_active";
          html += "<a class='search_item" + classAtt + "' onclick='click_search_w3schools_link(event)' href='search_entire_w3schools'>No matches found</a>";
        }
        a.innerHTML = html;
      }
