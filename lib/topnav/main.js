var TopNavBar = {
  ...
  const search_bar = document.getElementById('tnb-google-search-input');
  ...
  TopNavBar.searchWithSuggestions = function (inp) {
    ...
    searchSuggestionsElm.style.border = "2px solid #1000f2";
    ...
    for (i = 0; i < resultIndexes.length; i++) {
      ...
      html += `<a class ="search_item" href = "${array_search_suggestions[resultIndexes[i]][1]}"> ${cc} </a>`;
    }
    ...
    if (resultIndexes.length == 0) {
      ...
      var input_value = document.getElementById("tnb-google-search-input").value;
    ...
    // classAtt = "";
    // if (html == "") classAtt = " search_active";
    // html += '<button class="search_item' + classAtt + '" id="search-entire-w3schools-btn" style="border-top:1px solid #ddd;">On GoogleSearch .com</button>';
  ...
  ///for top voice searchbar
document.addEventListener("DOMContentLoaded", function () {
  const mic_on_alert = new Audio("/img/mic_on.mp3");
  const mic_off_alert = new Audio("/img/mic_off.mp3");
  var inputElement = document.getElementById("tnb-google-search-input");
  var startButton = document.getElementById("tnb-google-search-submit-btn");
